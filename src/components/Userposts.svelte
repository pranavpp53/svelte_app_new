<script>
    ...
    function updateRouteParams(data) {
    // Update the route parameters
    routeParams.set({ id: data });
  }
    ...
    <div class="home-post-container">
      <div class="post mt-5">
        ...
        <div class="button-container ms-auto ">
            <Link to="/edit">
              <button on:click={() => {
                updateRouteParams(i._id);
              }}  class="edit-button user-button text-success">Edit</button>
            </Link>
          <button
          ...
          <Link to="/view">
            <button  on:click={() => {
              updateRouteParams(i._id);
            }} class="view-button ms-3 user-button text-info">View</button>
          </Link>
        </div>
      </div>
    </div>
